...
/**
 * Created by HARUN on 16.12.2017.
 */

public class GecmisMenuAdapter extends BaseAdapter {

    LayoutInflater layoutInflater;
    ArrayList<SiparisMenu> secilenMenuList;
    String durumKontrol="bitti";
    FirebaseUser fUser;

    public GecmisMenuAdapter(Activity activity, ArrayList<SiparisMenu> secilenMenuList, FirebaseUser fUser){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(siparismenu.getGonderen().equals(fUser.getEmail())){
            if(siparismenu.getYDurum().equals(durumKontrol)) {
                satir = layoutInflater.inflate(R.layout.gecmismenu_satir, null);
